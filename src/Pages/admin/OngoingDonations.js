...
const OngoingDonations = (props) => {
    ...
    return (
        <div id="ongoing">
            {
                ongoing.length < 1 &&
                <p className="text-center faded">• No ongoing donations currently</p>
            }
            {
                        ...
                        <div className="item-details col-10 col-md-7 d-flex flex-column">
                            <div className="item-name d-flex flex-column">
                                <div className="d-flex">
                                    <strong className="text-capitalize">{donation.name}</strong>
                                    {donation.beneficiary && <p><span className="text-primary">is donating to ></span><span><strong>{donation.beneficiary.name}</strong></span></p>}
                                </div>
                                <p className="faded"> {donation.email}</p>
                            </div>
                            <div className="d-flex">
                                <p><strong className="text-capitalize">{donation.donationType}</strong></p>
                                <p className="faded text-capitalize">&nbsp; • {donation.beneficiary ? "No Beneficiary yet" : "Beneficiary chosen, in contact"}</p>
                            </div>
